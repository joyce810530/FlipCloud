<script>
    ...
    function burnFirmware() {
        ...
        if (portIndex != 0) {
            ...
            xhttp.open("GET", "https://cloudtw.fliprobot.com/firmware/E300_firmware_a5.hex", true);
            xhttp.send();
        }
    }
    ...
    function burnFirmwaret3() {
        ...
        if (portIndex != 0) {
            ...
            xhttp.open("GET", "https://cloudtw.fliprobot.com/firmware/SA1_T3.hex", true);
            xhttp.send();
        }
    }
    ...
    function burnFirmwaret4() {
        ...
        if (portIndex != 0) {
            ...
            xhttp.open("GET", "https://cloudtw.fliprobot.com/firmware/SA1_T4.hex", true);
            xhttp.send();
        }
    }
    ...
    function burnFirmwaret5() {
        ...
        if (portIndex != 0) {
            ...
            xhttp.open("GET", "https://cloudtw.fliprobot.com/firmware/SA1_T5.hex", true);
            xhttp.send();
        }
    }
    ...
    function burnFirmwaret6() {
        ...
        if (portIndex != 0) {
            ...
            xhttp.open("GET", "https://cloudtw.fliprobot.com/firmware/SA1_T6.hex", true);
            xhttp.send();
        }
    }
        ...
        if (portIndex != 0) {
            ...
            xhttp.open("GET", "https://cloudtw.fliprobot.com/firmware/L3SA2TP1_20180824.hex", true);
            xhttp.send();
        }
    }
